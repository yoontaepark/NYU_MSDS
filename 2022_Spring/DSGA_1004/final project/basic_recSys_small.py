...
# if you want to measure the stability of your implementation.
    ...
    # train_df.coalesce(1).write.option('header', True).csv('train_df_small.csv')
    # val_df.coalesce(1).write.option('header', True).csv('val_df_small.csv')
    # test_df.coalesce(1).write.option('header', True).csv('test_df_small.csv')
